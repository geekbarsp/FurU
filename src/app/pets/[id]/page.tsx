        ...
        <div className="profile-grid">
          <div className="profile-image">
            ...
            <div className="photo-note">
              Original FurU portrait · Verified listing
            </div>
          </div>
          <div className="profile-content">
            ...
            <p className="location-line">
              <MapPin size={17} /> {pet.location} · Approximate location
            </p>
            <div className="chips">
              {pet.traits.map((t) => (
            ...
            <div className="info-list">
              ...
              <div className="info">
                ...
                <b>{pet.vaccinated ? "Up to date" : "In progress"}</b>
              </div>
            </div>
            {pet.specialNeeds && (
            ...
            <h3 className="profile-question">
              Could you be {pet.name}&apos;s person?
            </h3>
            <p>
              Good with {pet.goodWith.join(", ").toLowerCase()}. A secure indoor
              sleeping area and an introductory meet-and-greet are preferred.
            </p>
            <PetProfileActions id={pet.id} name={pet.name} />
            <div className="notice partner-notice">
              <BadgeCheck size={22} />
              <span>
                <b>{pet.organization}</b>
                <br />
                Trust Score 4.7 / 5 · 3 verified reviews · Responds in about 1 day
              </span>
            </div>
          </div>
        </div>
